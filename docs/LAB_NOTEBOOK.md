# Bitácora de laboratorio (fase por fase)

> Log cronológico del proyecto, en español, tal como se construyó: cada fase
> con su motivación, números y figuras. Para la vista pública ver el
> [README](../README.md) (inglés); para los hallazgos ordenados,
> [NARRATIVA.md](NARRATIVA.md).

Punto de partida del proyecto: **predicción puramente latente (estilo JEPA)
con dinámica de tiempo continuo (Neural ODE), sin decoder**, para series
temporales.
...
- **Fase 1 (hecha)** — sweep de irregularidad $`s`$ ($`\Delta t \sim \Delta t_0 \cdot U(1-s, 1+s)`$),
  ...
  | 0.3 | 0.198 ± .019 | 0.207 ± .010 | 0.343 ± .030 | 0.089 ± .001 |
  | 0.6 | **0.187 ± .010** | 0.345 ± .019 | 0.435 ± .011 | 0.090 ± .001 |
  | 0.9 | **0.186 ± .033** | 0.471 ± .025 | 0.534 ± .023 | 0.091 ± .001 |

  *(números re-medidos con 3 seeds; la corrida original de una seed daba la
  misma historia)*
